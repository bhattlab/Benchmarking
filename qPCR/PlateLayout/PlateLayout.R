...
# Full Conversion
layout96 <- read.csv(here("qPCR/qPCR_plate4_96welllayout.csv"), sep=",", header = FALSE)
layout_conversion <- read.csv(here("qPCR/format_conversion.tsv"), sep="\t", header = FALSE)
...
write.table(full_layout, here("qPCR/Plate_4/Plate4_Layout.csv"), sep=",", row.names=FALSE, quote=FALSE)
